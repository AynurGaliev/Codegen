...
final class TWComplaint: TWObject {
	...
	init(archived: Bool, cases: TWCase?, complaintSet: String?, createdAt: Date, id: String, localUpdatedAt: Date, name: String, order: Int?, priority: Int, showInterventions: Bool, showOnsets: Bool, showSymptoms: Bool, showVitals: Bool, tags: [TWTag]?, updatedAt: Date?) {
...
func ==(lhs: TWComplaint, rhs: TWComplaint) -> Bool {
